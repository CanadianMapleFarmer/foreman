...
- [ ] **Step 3: Write package.json, tsconfig, version, cli stub**
...
- [ ] **Step 3: Implement roles.ts and config.ts and prompts**
...
- [ ] **Step 4: Run tests; tighten `escapesWorktree` until all pass**
